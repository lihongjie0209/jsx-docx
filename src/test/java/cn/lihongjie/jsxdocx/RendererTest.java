    ...
    public void rendersHeading() throws Exception {
        String jsx = """
                render(
                  <Document>
                    <Styles>
                      <Style styleId="H1" type="paragraph" name="Heading 1" bold={true} fontSize={32} />
                    </Styles>
                    <Heading styleId="H1">Main Title</Heading>
        ...
        try (FileInputStream fis = new FileInputStream(out.toFile());
            ...
            assertEquals("H1", doc.getParagraphs().get(0).getStyle());
        }
    }
